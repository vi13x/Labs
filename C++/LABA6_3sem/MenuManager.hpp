    ...
    while (true)
    {
        try
        {
            ...
            if (cin.fail())
            {
                cin.clear();
                cin.ignore(numeric_limits<streamsize>::max(), '\n');
                throw InvalidArgumentException("choice", "Неверный формат ввода");
            }
        ...
        {
            e.handle();
            cout << "Попробуйте снова или уменьшите количество данных.\n\n";
        }
        catch (const InvalidArgumentException& e)
        {
            e.handle();
            cout << "Попробуйте ввести корректные данные.\n\n";
        }
        catch (const OutOfRangeException& e)
        {
            e.handle();
            cout << "Попробуйте выбрать корректный индекс.\n\n";
        }
        catch (const LengthErrorException& e)
        {
            e.handle();
            cout << "Попробуйте уменьшить размер данных.\n\n";
        }
        catch (const DomainErrorException& e)
        {
            e.handle();
            cout << "Попробуйте ввести корректные значения.\n\n";
        }
        catch (const OverflowErrorException& e)
        {
            e.handle();
            cout << "Значение слишком большое. Попробуйте уменьшить.\n\n";
        }
        catch (const UnderflowErrorException& e)
        {
            e.handle();
            cout << "Операция невозможна: недостаточно данных.\n\n";
        }
        catch (const RuntimeErrorException& e)
        {
            e.handle();
            cout << "Ошибка времени выполнения. Попробуйте снова.\n\n";
        }
        ...
        {
            cout << "Неизвестная ошибка! Попробуйте снова.\n\n";
        }
    }
}
